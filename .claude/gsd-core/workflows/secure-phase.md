...
```
Agent(
  prompt="Read /home/user/monai/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/monai/.claude/gsd-core/templates/SECURITY.md`
