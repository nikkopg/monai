...
```markdown
Read /home/user/monai/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/monai/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/monai/.claude/agents/gsd-ui-checker.md for instructions.
