...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/monai/.claude/.gsd-surface.json`
(sibling to `/home/user/monai/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/monai/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/monai/.claude/skills`).
...
`/home/user/monai/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/monai/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/monai/.claude/.gsd-surface.json`
Install profile marker: `/home/user/monai/.claude/.gsd-profile`
Skill dirs: `/home/user/monai/.claude/skills/gsd-*/`
Engine module: `/home/user/monai/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/monai/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
