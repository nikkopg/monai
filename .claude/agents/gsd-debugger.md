...
<required_reading>
@/home/user/monai/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/monai/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/monai/.claude
                  → checks /home/user/monai/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/monai/.claude/gsd-core
                  → writes to /home/user/monai/.claude/gsd-core/hooks/
...
@/home/user/monai/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/monai/.claude/gsd-core/references/common-bug-patterns.md
