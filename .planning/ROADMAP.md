...
- [x] 05-01-PLAN.md — Alembic 004 (platforms, portfolio_value_history, holdings.platform_id FK) + models + yfinance/apscheduler deps + Wave-0 test scaffolds (D-17) [wave 1]
...
- [x] 05-03-PLAN.md — Ledger + P&L keystone: avg-cost recompute, holding/event writes, GET /investments/summary, HoldingModal/HoldingOverrideModal, grouped holding cards (D-01/02/03/05/16, INV-01/06/07) [wave 3]
...
- [x] 07-02-PLAN.md — Currency-aware valuation + cash special-case + gold ledger + asset-type grouping (Wave 2, depends 01) [FX-03, CG-01/02/03]
- [x] 07-03-PLAN.md — Allocation pie chart (asset-type↔platform toggle, current IDR value) (Wave 3, depends 02) [VZ-01]
